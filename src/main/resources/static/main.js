...
/* harmony import */ var _store_services_StoreService__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./store/services/StoreService */ "./src/app/store/services/StoreService.ts");
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            providers: [_store_services_StoreService__WEBPACK_IMPORTED_MODULE_1__["StoreService"]]
        })
    ], AppComponent);
    return AppComponent;
}());
...
/* harmony import */ var _store_products_products_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./store/products/products.component */ "./src/app/store/products/products.component.ts");
/* harmony import */ var _store_orders_orders_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./store/orders/orders.component */ "./src/app/store/orders/orders.component.ts");
/* harmony import */ var _store_shopping_cart_shopping_cart_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./store/shopping-cart/shopping-cart.component */ "./src/app/store/shopping-cart/shopping-cart.component.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _store_store_component__WEBPACK_IMPORTED_MODULE_3__["StoreComponent"],
                _store_products_products_component__WEBPACK_IMPORTED_MODULE_4__["ProductsComponent"],
                _store_orders_orders_component__WEBPACK_IMPORTED_MODULE_5__["OrdersComponent"],
                _store_shopping_cart_shopping_cart_component__WEBPACK_IMPORTED_MODULE_6__["ShoppingCartComponent"]
            ],
            imports: [
            ...
            providers: [_store_store_component__WEBPACK_IMPORTED_MODULE_3__["StoreComponent"]],
...
/***/ "./src/app/store/models/product-order.model.ts":
/*!*****************************************************!*\
  !*** ./src/app/store/models/product-order.model.ts ***!
  \*****************************************************/
...
/***/ "./src/app/store/models/product-orders.model.ts":
/*!******************************************************!*\
  !*** ./src/app/store/models/product-orders.model.ts ***!
  \******************************************************/
...
/***/ "./src/app/store/orders/orders.component.html":
/*!****************************************************!*\
  !*** ./src/app/store/orders/orders.component.html ***!
  \****************************************************/
/*! no static exports found */
...
/***/ "./src/app/store/orders/orders.component.ts":
/*!**************************************************!*\
  !*** ./src/app/store/orders/orders.component.ts ***!
  \**************************************************/
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _services_StoreService__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../services/StoreService */ "./src/app/store/services/StoreService.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var OrdersComponent = /** @class */ (function () {
    function OrdersComponent(storeService) {
    ...
    OrdersComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.paid = false;
        this.sub = this.storeService.OrdersChanged.subscribe(function () {
            _this.orders = _this.storeService.ProductOrders;
        });
        this.loadTotal();
    };
    ...
    OrdersComponent.prototype.loadTotal = function () {
        var _this = this;
        this.sub = this.storeService.TotalChanged.subscribe(function () {
            _this.total = _this.storeService.Total;
        });
    };
    OrdersComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-orders',
            template: __webpack_require__(/*! ./orders.component.html */ "./src/app/store/orders/orders.component.html"),
            styles: [__webpack_require__(/*! ./orders.component.css */ "./src/app/store/orders/orders.component.css")]
        }),
        __metadata("design:paramtypes", [_services_StoreService__WEBPACK_IMPORTED_MODULE_1__["StoreService"]])
    ], OrdersComponent);
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _models_product_order_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../models/product-order.model */ "./src/app/store/models/product-order.model.ts");
/* harmony import */ var _services_StoreService__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/StoreService */ "./src/app/store/services/StoreService.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ProductsComponent = /** @class */ (function () {
    function ProductsComponent(storeService) {
        this.storeService = storeService;
        this.productOrders = [];
        this.products = [];
    ...
    ProductsComponent.prototype.loadOrders = function () {
        var _this = this;
        this.sub = this.storeService.OrdersChanged.subscribe(function () {
            _this.shoppingCartOrders = _this.storeService.ProductOrders;
        });
    };
    ...
    ProductsComponent.prototype.getProductIndex = function (product) {
        return this.storeService.ProductOrders.productOrders.findIndex(function (value) { return value.product === product; });
    };
    ...
    ProductsComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_StoreService__WEBPACK_IMPORTED_MODULE_2__["StoreService"]])
    ], ProductsComponent);
...
/***/ "./src/app/store/services/StoreService.ts":
/*!************************************************!*\
  !*** ./src/app/store/services/StoreService.ts ***!
  \************************************************/
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _models_product_orders_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../models/product-orders.model */ "./src/app/store/models/product-orders.model.ts");
...
var StoreService = /** @class */ (function () {
    function StoreService(http) {
        ...
        this._orders = new _models_product_orders_model__WEBPACK_IMPORTED_MODULE_1__["ProductOrders"]();
        this.productOrderSubject = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
        this.ordersSubject = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
        this.totalSubject = new rxjs__WEBPACK_IMPORTED_MODULE_2__["Subject"]();
    ...
    StoreService.prototype.saveOrder = function (order) {
        return this.http.post(this.ordersUrl, order);
    };
    Object.defineProperty(StoreService.prototype, "SelectedProductOrder", {
        get: function () {
    ...
    Object.defineProperty(StoreService.prototype, "ProductOrders", {
        get: function () {
            return this._orders;
        },
        set: function (value) {
    ...
    Object.defineProperty(StoreService.prototype, "Total", {
        get: function () {
            return this._total;
        },
        set: function (value) {
...
/***/ "./src/app/store/shopping-cart/shopping-cart.component.css":
/*!*****************************************************************!*\
  !*** ./src/app/store/shopping-cart/shopping-cart.component.css ***!
  \*****************************************************************/
/*! no static exports found */
...
/***/ "./src/app/store/shopping-cart/shopping-cart.component.html":
/*!******************************************************************!*\
  !*** ./src/app/store/shopping-cart/shopping-cart.component.html ***!
  \******************************************************************/
/*! no static exports found */
...
/* harmony import */ var _models_product_orders_model__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../models/product-orders.model */ "./src/app/store/models/product-orders.model.ts");
/* harmony import */ var _services_StoreService__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../services/StoreService */ "./src/app/store/services/StoreService.ts");
/* harmony import */ var _models_product_order_model__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../models/product-order.model */ "./src/app/store/models/product-order.model.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var ShoppingCartComponent = /** @class */ (function () {
    function ShoppingCartComponent(storeServie) {
        this.storeServie = storeServie;
        this.total = 0;
    ...
    ShoppingCartComponent.prototype.loadTotal = function () {
        var _this = this;
        this.sub = this.storeServie.OrdersChanged.subscribe(function () {
            _this.total = _this.calculateTotal(_this.orders.productOrders);
        });
    };
    ShoppingCartComponent.prototype.loadCart = function () {
        var _this = this;
        this.sub = this.storeServie.ProductOrderChanged.subscribe(function () {
            var productOrder = _this.storeServie.SelectedProductOrder;
            if (productOrder) {
            ...
            _this.storeServie.ProductOrders = _this.orders;
            _this.orders = _this.storeServie.ProductOrders;
            _this.total = _this.calculateTotal(_this.orders.productOrders);
        });
    };
    ...
    ShoppingCartComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./shopping-cart.component.html */ "./src/app/store/shopping-cart/shopping-cart.component.html"),
            styles: [__webpack_require__(/*! ./shopping-cart.component.css */ "./src/app/store/shopping-cart/shopping-cart.component.css")]
        }),
        __metadata("design:paramtypes", [_services_StoreService__WEBPACK_IMPORTED_MODULE_2__["StoreService"]])
...
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _products_products_component__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./products/products.component */ "./src/app/store/products/products.component.ts");
/* harmony import */ var _shopping_cart_shopping_cart_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./shopping-cart/shopping-cart.component */ "./src/app/store/shopping-cart/shopping-cart.component.ts");
/* harmony import */ var _orders_orders_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./orders/orders.component */ "./src/app/store/orders/orders.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var StoreComponent = /** @class */ (function () {
    ...
    StoreComponent.prototype.toggleCollapsed = function () {
        this.collapsed = !this.collapsed;
    };
    StoreComponent.prototype.finishOrder = function (orderFinished) {
        this.orderFinished = orderFinished;
    };
    StoreComponent.prototype.reset = function () {
        this.orderFinished = false;
    ...
    ], StoreComponent.prototype, "productsC", void 0);
    __decorate([
    ...
    ], StoreComponent.prototype, "shoppingCartC", void 0);
    __decorate([
    ...
    ], StoreComponent.prototype, "ordersC", void 0);
...
module.exports = __webpack_require__(/*! /Users/libin/Code/github.com/binblee/bootstore/src/main/frontend/src/main.ts */"./src/main.ts");
